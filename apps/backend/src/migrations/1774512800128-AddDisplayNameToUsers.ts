...
export class AddDisplayNameToUsers1774512800128 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "portfolio_snapshots" DROP CONSTRAINT "FK_portfolio_snapshots_userId"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_portfolio_snapshots_userId_createdAt"`);
        ...
        await queryRunner.query(`ALTER TABLE "portfolio_assets" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "portfolio_assets" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "portfolio" jsonb NOT NULL DEFAULT '[]'`);
        await queryRunner.query(`ALTER TABLE "users" ADD "rewards" jsonb NOT NULL DEFAULT '{"totalEarned":0}'`);
        await queryRunner.query(`ALTER TABLE "users" ADD "lastLogin" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "users" ADD "isActive" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_8bc9b0048dfefcac4f0259bf3ae" UNIQUE ("stellarPublicKey")`);
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_8bc9b0048dfefcac4f0259bf3ae"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "stellarPublicKey"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "stellarPublicKey" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_8bc9b0048dfefcac4f0259bf3ae" UNIQUE ("stellarPublicKey")`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "email"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "email" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email")`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "preferences" SET DEFAULT '{"theme":"dark","notifications":{"email":true,"push":true}}'`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "articles" ADD CONSTRAINT "UQ_143e4ae40220e82a7829dee20e7" UNIQUE ("url")`);
        await queryRunner.query(`ALTER TABLE "articles" DROP COLUMN "sentimentScore"`);
        await queryRunner.query(`ALTER TABLE "articles" ADD "sentimentScore" double precision`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "id"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_8bc9b0048dfefcac4f0259bf3ae"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "stellarPublicKey"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "stellarPublicKey" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_8bc9b0048dfefcac4f0259bf3ae" UNIQUE ("stellarPublicKey")`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "createdAt"`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_8bc9b0048dfefcac4f0259bf3a" ON "users" ("stellarPublicKey") `);
        await queryRunner.query(`CREATE INDEX "IDX_fde671dad2a68d61cdc532c96c" ON "portfolio_snapshots" ("userId", "createdAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_1143abb8c3fad8b06dd857a8c9" ON "password_reset_tokens" ("tokenHash") `);
        await queryRunner.query(`ALTER TABLE "stellar_accounts" ADD CONSTRAINT "FK_e00ee11642074093e8296354812" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "portfolio_snapshots" ADD CONSTRAINT "FK_35bee2c1e38cf9298c2a5033406" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "portfolio_snapshots" DROP CONSTRAINT "FK_35bee2c1e38cf9298c2a5033406"`);
        await queryRunner.query(`ALTER TABLE "portfolio_assets" DROP CONSTRAINT "FK_d4f98a41174caf9217c1498f387"`);
        await queryRunner.query(`ALTER TABLE "stellar_accounts" DROP CONSTRAINT "FK_e00ee11642074093e8296354812"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1143abb8c3fad8b06dd857a8c9"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_fde671dad2a68d61cdc532c96c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8bc9b0048dfefcac4f0259bf3a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_97672ac88f789774dd47f7c8be"`);
        await queryRunner.query(`ALTER TABLE "articles" DROP CONSTRAINT "UQ_143e4ae40220e82a7829dee20e7"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "preferences" SET DEFAULT '{"notifications": {"newsAlerts": true, "priceAlerts": true, "securityAlerts": true}}'`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "email"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "email" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email")`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id")`);
        await queryRunner.query(`ALTER TABLE "articles" DROP COLUMN "sentimentScore"`);
        await queryRunner.query(`ALTER TABLE "articles" ADD "sentimentScore" numeric(10,4)`);
        await queryRunner.query(`ALTER TABLE "articles" DROP CONSTRAINT "UQ_143e4ae40220e82a7829dee20e7"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "createdAt"`);
        ...
        await queryRunner.query(`ALTER TABLE "portfolio_assets" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "portfolio_assets" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "role"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."UQ_daily_snapshots_date_asset"`);
        await queryRunner.query(`DROP TABLE "daily_snapshots"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_30de7c930c0b503349dea29979"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3fd11f33a2c4378c5b981b7ab6"`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_portfolio_snapshots_userId_createdAt" ON "portfolio_snapshots" ("userId", "createdAt") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_97672ac88f789774dd47f7c8be" ON "users" ("email") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_users_stellarPublicKey" ON "users" ("stellarPublicKey") `);
        ...
        await queryRunner.query(`ALTER TABLE "portfolio_snapshots" ADD CONSTRAINT "FK_portfolio_snapshots_userId" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
